...
def load_config(path):
    ...
    if not isinstance(hand_refinement.get("method"), str) or not hand_refinement.get("method").strip():
        raise ValueError("hand_refinement.method must be a non-empty string")
